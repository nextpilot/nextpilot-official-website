...
7. DO：4路；
8. ADC采集：4路；
9. 陀螺仪：测量范围±400°/s、陀螺仪零偏20°/h（1σ）；
10. 加速度计：测量范围±10g、加速度计零偏1mg；
11. 工作温度：-40℃~75℃；
12. 贮存温度：-45℃~80℃；
13. 高低温工作、振动、冲击、电磁兼容符合GJB要求。
...
| 38   | 89   | FCS_CH11       | PWM输出CH11                    | VTOL（升降舵机/左V尾舵机）        |
| 39   | 90   | FCS_CH12       | PWM输出CH12                    | VTOL（方向舵机/右V尾舵机）        |
| 40   | 91   | FCS_CH13       | PWM输出CH13                    |                                   |
...
| 49   | 85   | RC_SBUS_IN     | 飞控串口8，SBUS信号输入        | FUTABA接收机                      |
| 50   | 84   | RC_SBUS_OUT    | 飞控串口8，SBUS信号输出        |                                   |
| 51   | 82   | RC_GND         | GND2                           |                                   |
...
| 71   | 66   | FCS_RS232_RX2  | 飞控板串口6（RS232）           | 吊舱                              |
| 72   | 67   | FCS_RS232_TX2  |                                |                                   |
| 73   | 68   | FCS_RS232_GND  |                                |                                   |
...
| 91   | 131  | FCS_RS422_A3   | 飞控板串口3（RS422）           | 机载计算机进行外部控制            |
| 92   | 132  | FCS_RS422_B3   |                                |                                   |
| 93   | 133  | FCS_RS422_Y3   |                                |                                   |
| 94   | 134  | FCS_RS422_Z3   |                                |                                   |
