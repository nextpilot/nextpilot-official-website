...
helpUrl: /docs/manual/navigator/np-ads-h05
---
...
- 高度测量范围：-300~+6000m；
- 空速测量范围：0~335.5m/s；
- 接口数量：1路 RS422、1路 CAN、1路 IIC、1路 USB；
- 工作温度：-40℃~75℃；
- 贮存温度：-45℃~80℃；
...
大气数据计算机提供了两个连接空速管的接头，PS 为静压管，PT 为动压管。大气数据计算机提供了航空连接器，型号为 J30J-21ZKW-J，接口布局如下图右侧所示。
