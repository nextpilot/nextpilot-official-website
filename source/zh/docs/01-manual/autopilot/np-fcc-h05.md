...
- 支持多种机型，包括多旋翼、固定翼、垂起（VTOL）；
- 具备手动、定高、定点、特技、悬停、任务航线、外部控制、自主起降、返航等多种飞行模式；
- 具备数据链丢失保护、卫星信号丢失保护、发动机失效保护、低电压告警及保护等各类应急保护逻辑；
- 具备异地起降功能；
- 具备电子围栏功能；
- 具备硬件在环仿真及软件仿真功能；
- 具备多机控制能力；
- 支持多级编队；
- 广泛支持各类卫星导航板卡，包括 Novatel（OEM718D）、和芯星通（UM482、UM982）等板卡；
- 搭载高精度工业级 IMU，无需外部减震；
- 具备软件串口升级功能；
- 具备日志记录回放能力（PX4日志格式）；
- 具备软件版本查询功能。
...
- DO：4路；
- ADC 采集：4路；
- 陀螺仪：测量范围±400°/s、陀螺仪零偏 20°/h（1σ）；
- 加速度计：测量范围±10g、加速度计零偏 1mg；
- 工作温度：-40℃~75℃；
- 贮存温度：-45℃~80℃；
